...
export default function Header({data}) {
  ...
  // 6. propdrilling--> other data created and it gooes into subheader.js---------------
  let shirt ="--Shirt";
  let pant ="--Pant";
  ...
  return (
    ...
    <header>
      ...
      <div className="header">
        ...
        <div className="header-address">
          ...
          <div className="address-content">
            ...
            {/* 4. task var give into header.js using destructure----------------------------- */}
      ...
      {/* 7. propdrilling--> data(name,test) from app.js & new created variable 
      shirt & pant from header.js goes into sunheader.js ------& go subheader.js */}
      <Subheader subData ={{data, shirt, pant}} />
